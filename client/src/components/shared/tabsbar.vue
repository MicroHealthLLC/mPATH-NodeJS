<template>
  <div id="tabbar" data-cy="main_tab">
    ...
    <router-link v-if="permitted('kanban_view')" :to="routeKanbanSwap" tag="div">
      <div v-show="!isContractView && !isVehicleView && !isEffortsView" class="badge" :class="{ active: isKanbanView }"
        data-cy="kanban_tab">
        Kanban
      </div>
    </router-link>
    <router-link v-if="permitted('calendar_view')" :to="routeCalendarSwap" tag="div">
      <div class="badge" v-show="!isContractView && !isVehicleView && !isEffortsView"
        :class="{ active: isCalendarView }" data-cy="calendar_tab">
        Calendar
      </div>
    </router-link>
    <router-link v-if="permitted('map_view')" :to="routeMapSwap" tag="div">
      <div class="badge" :class="{ active: isMapView }" data-cy="map_tab"
        v-show="!isContractView && !isVehicleView && !isEffortsView">
        Map
      </div>
    </router-link>
    <router-link v-if="permitted('gantt_view')" :to="`/programs/${this.$route.params.programId}/gantt_chart`" tag="div">
    ...
    <router-link v-if="permitted('members')" :to="`/programs/${this.$route.params.programId}/members`" tag="div">
      <div class="badge" :class="{ active: isMembersView }" data-cy="team_tab">
        Team
      </div>
    </router-link>
    <router-link v-if="false" :to="routeLessonSwap" tag="div">
