...
const settingsStore = {
  ...
  mutations: {
    ...
    setNewVehicleGroupFilter: (state, loaded) => (state.new_vehicle_group_filter = loaded),
    ...
    // VEHICLES
    SET_ASSIGNED_VEHICLE_USERS: (state, value) => (state.assigned_vehicle_users = value),
    SET_BULK_VEHICLE_ROLE_NAMES: (state, value) => (state.bulk_vehicle_role_names = value),
    SET_VEHICLE_ROLE_USERS: (state, value) => (state.vehicle_role_users = value),
    SET_VEHICLE_ROLE_NAMES: (state, value) => (state.vehicle_role_names = value),
    SET_USERS_VEHICLE_ROLES: (state, value) => (state.users_vehicle_roles = value),
    SET_ASSOCIATED_VEHICLES: (state, value) => (state.associated_vehicles = value),
    SET_EDIT_VEHICLE_SHEET: (state, value) => (state.edit_vehicle_sheet = value),
    ...
    SET_REMOVE_VEHICLE_ROLE_STATUS: (state, status) => (state.remove_vehicle_role_status = status),
    ...
    SET_VEHICLE_GROUP_TYPES: (state, loaded) => (state.vehicle_group_types = loaded),
    SET_VEHICLE_STATUSES_FILTER: (state, loaded) => (state.vehicle_statuses_filter = loaded),
    SET_VEHICLE_CLASSIFICATIONS: (state, value) => (state.vehicle_classifications = value),
