...
module.exports = (sequelize, DataTypes) => {
  class RolePrivilege extends Model {
    ...
    static PROJECT_PRIVILEGES_ROLE_TYPES = [this.PROJECT_ANALYTICS, this.PROJECT_TASKS, this.PROJECT_ISSUES, this.PROJECT_RISKS, this.PROJECT_LESSONS, this.PROJECT_NOTES, this.PROJECT_EFFORTS]
    ...
    static CONTRACT_PRIVILEGES_ROLE_TYPES = [this.CONTRACT_ANALYTICS, this.CONTRACT_TASKS, this.CONTRACT_ISSUES, this.CONTRACT_RISKS, this.CONTRACT_LESSONS, this.CONTRACT_NOTES]
