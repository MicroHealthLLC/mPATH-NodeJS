...
module.exports = (sequelize, DataTypes) => {
  class Task extends Model {
    ...
    async toJSON(){
      ...
      _resource["sub_task_ids"] =  _.map(_resource["sub_tasks"], function(u){ u.id} )
      _resource["sub_issue_ids"] = _.map(_resource["sub_issues"], function(u){ u.id} )
      _resource["sub_risk_ids"] = _.map(_resource["sub_risks"], function(u){ u.id} )
