  ...
  async up (queryInterface, Sequelize) {
    ...
    */
    ...
    const [facilityGroup, fgcreated] = await db.FacilityGroup.findOrCreate({
      where: { name: 'Sample Group', code: 'SAMP', status: 'active' },
      defaults: {}
    });
    ...
    const [setting, screated] = await db.Setting.findOrCreate({
      where: { google_map_key: ENV['GOOGLE_MAP_KEY'] },
      defaults: {}
    });
    ...
    contract_types.forEach(function(e){
    ...
    contract_statues.forEach(function(e){
    ...
    var contract_name_customers = ["VA",  "IPO",  "DHA",  "3M",  "DIA",  "SEC",  "Army",  "USCG",  "HHS/HRSA",  "ARNG",  "DHMS/DHA",  "HRSA",  "DOS",  "SBA",  "DOE"]

    contract_name_customers.forEach(function(e){
    ...
    var contract_vehicles = ["VAEHRM","Connections II","GSA IT-70 SIN 132-51","T4NG","8(a) STARS2","GSA IT-70","GSA PSS","DIA ESITA 2","WITS 3","CIO-SP3 (SDVOSB)","GAS","GSA IT-70 SIN 132-56","VETS 2 GWAC ","TBA","N/A"]

    contract_vehicles.forEach(function(e){
    ...
    var contract_vehicle_numbers = ["0353-21-2545","19AQMM19D0147","36C10B18D5000","36C10B20N0015","36C10B20N0028","47QRAA-18-D-0098","GS00Q17GWD2387","47QTCH18D0041","GS11T08BJD6001","GS-35F-0142W","GS35F349CA","GS-35F-413BA","HHSN316201800023W","HHM402-17-A-0007","HT003821C0006","VA118-16-D-1006","N/A","TBD"]
    
    contract_vehicle_numbers.forEach(function(e){
    ...
    var contract_primes = ["3M","American Systems Cooperation","AstraFine JV LLC","Cerner Government Services, inc.","Diverse Systems Group, LLC","Favor TechConsulting, LLC","Innovative Information Solutions, LLC","ManTech Advance Systems International, inc.","MicroHealth, LLC","Planned Systems International inc.","Verizon Federal Services, inc."]
    contract_primes.forEach(function(e){
    ...
    var contract_current_pops = ["Base Period","Base Period 2","Contract Yr 3","Option Period 1","Option Period 2","Option Period 3","Option Period 4","Option Year 1"]
    contract_current_pops.forEach(function(e){
    ...
    contract_classification.forEach(function(e){
    ...
    contract_categories.forEach(function(e){
    ...
    contract_client_types.forEach(function(e){
